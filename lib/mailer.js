...
async function sendClientConfirmation({ email, firstName, amount, bankName }) {
  ...
  const content = `
    <div style="text-align:center;margin-bottom:40px;">
      <table cellpadding="0" cellspacing="0" style="margin:0 auto 24px;"><tr><td style="width:80px;height:80px;background:#e8f5e9;border-radius:50%;text-align:center;vertical-align:middle;font-size:36px;line-height:80px;">✅</td></tr></table>
